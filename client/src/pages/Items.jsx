...
const BLANK = { name: '', brand: '', description: '', unit: '', unit_price: '', material_key: '', sf_per_pallet: '' };
    ...
    <>
      <div className="page-head">
        <div>
          ...
          <p className="sub">Preset materials and services with their usual cost, so estimates and the material calculator can pull in a product name, description, and unit cost instead of retyping them. Paver products can also carry a brand and SF-per-pallet coverage, so picking one in the calculator fills in the pallet math automatically.</p>
        </div>
      ...
      {!items ? <div className="loading">Loading…</div> : items.length === 0 ? (
        ...
        <div className="table-wrap">
          <table className="list">
            <thead><tr><th>Product name</th><th>Brand</th><th>Description</th><th>Unit cost</th><th>Unit</th><th>SF/pallet</th><th>Linked to</th><th></th></tr></thead>
            <tbody>
              {items.map((item) => {
